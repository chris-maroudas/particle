# RailsAdmin config file. Generated on April 19, 2014 05:04
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Particle', 'Admin']
  ...
  # config.excluded_models = ['Article', 'Ckeditor::Asset', 'Ckeditor::AttachmentFile', 'Ckeditor::Picture', 'Menu', 'Node', 'NodeType', 'Role', 'StaticPage', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Article', 'Ckeditor::Asset', 'Ckeditor::AttachmentFile', 'Ckeditor::Picture', 'Menu', 'Node', 'NodeType', 'Role', 'StaticPage', 'User']
  ...
  #     configure :id, :integer 
  #     configure :menu_id, :integer         # Hidden 
  #     configure :node_type_id, :integer         # Hidden 
  #     configure :position, :integer 
  #     configure :name, :string 
  #     configure :optional_field, :string 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your node_type.rb model definition
